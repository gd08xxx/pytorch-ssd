...
# MODIFIED
parser.add_argument('--width', type=int, default=512, help="input width of the model to be exported (in pixels)")
# MODIFIED
parser.add_argument('--height', type=int, default=512, help="input height of the model to be exported (in pixels)")
